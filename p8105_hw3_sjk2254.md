...
on average, compared to the other two educational groups. Between the
sex, there is fairly similar patterns except in the more than high
school education level where the males have a noticeable greater
increase in MIMS values than females, during the later minutes.
